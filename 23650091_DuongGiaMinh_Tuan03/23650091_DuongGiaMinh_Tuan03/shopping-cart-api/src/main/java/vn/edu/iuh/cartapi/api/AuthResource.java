...
public class AuthResource {
    ...
    @GET
    @Path("/session")
    public Map<String, Object> session(@Context jakarta.servlet.ServletContext context) {
        java.util.concurrent.atomic.AtomicInteger activeUsers =
                (java.util.concurrent.atomic.AtomicInteger) context.getAttribute("activeUsersCount");
        ...
        return Map.of(
                ...
                "instanceId",
                userSession.getInstanceId(),
                "activeUsers", activeUsers != null ? activeUsers.get() : 0
        );
    }
